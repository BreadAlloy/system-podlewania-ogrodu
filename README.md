...
### Instalacja i wstepna konfiguracja programu 
...
### Zatrzymywanie z usunięciem utworzonych przez program plików
...
mozna dodatkowo usunac pliki programu

```bash
sudo rm -rf {sciezka do programu}/system-podlewania-ogrodu 
```
...
* [Kontakt z zespołem](https://github.com/BreadAlloy/system-podlewania-ogrodu/issues)
* [Link do repozytorium](https://github.com/BreadAlloy/system-podlewania-ogrodu)